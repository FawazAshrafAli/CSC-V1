...
function populateDistricts() {
    ...
    // Clear the district dropdown before populating it with new options
    districtDropdown.innerHTML = "<option hidden disabled selected>Select District</option>";

    // Populate the district dropdown with options based on the selected state    

    stateCities[selectedState].forEach(function(district) {
